...
class SettingsRepository implements SettingsRepositoryI {
  SettingsRepository({required KeyValueStorageI keyValueStorage})
  ...
  Future<void> setTheme(ThemeMode themeMode) async {
    return await _keyValueStorage.set<String>(
        key: _themeModeKey, value: themeMode.asString());
  }

  @override
  Future<ThemeMode> getCurrentTheme() async {
    final String? themeModeStr = await _keyValueStorage.get<String>(key: _themeModeKey);
